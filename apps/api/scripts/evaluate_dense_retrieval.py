"""Evaluate dense legal retrieval with Recall@k, Hit@k and MRR."""
...
DEFAULT_OUTPUT = (
    ...
    / "evaluation"
    / "results"
    / "dense_eval_results.json"
)


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Evaluate dense legal retrieval.",
    )
...
def main() -> int:
    ...
    output = {
        "pipeline": "dense_bge_m3_finetuned",
